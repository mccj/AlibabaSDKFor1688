...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("转换成 json 文件并保存");
            var jsonWebSocketStandard = documentWebSocketStandard.ToJson();
            System.IO.File.WriteAllText(@"..\..\..\..\..\sdk\AlibabaSDKFor1688\AlibabaWebSocketClient.json", jsonWebSocketStandard);

            Console.WriteLine("转换成 ClientModels 代码并保存");
            var csharpModelsCodeWebSocketStandard = apiDocumentWebSocketStandard.ToCSharpCode(documentWebSocketStandard, "AlibabaSDK.WebSocketModels");
