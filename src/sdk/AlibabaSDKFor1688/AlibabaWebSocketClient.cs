...
namespace AlibabaSDK
{
    public partial class AlibabaWebSocketClient
    {
        ...
        public AlibabaWebSocketClient(string appKey) : this(appKey, new HttpClient())
        {
        }
        public AlibabaWebSocketClient(string appKey, System.Net.Http.HttpClient httpClient) //: this(httpClient)
        {
            //this._appKey = appKey;
        }
